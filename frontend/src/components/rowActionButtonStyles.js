...
export const ROW_ACTION_BUTTON_CLASS =
  "quill-row-action-btn inline-flex shrink-0 items-center justify-center rounded-lg border w-7 h-7 bg-slate-50 border-slate-200 text-slate-500 disabled:opacity-40 disabled:pointer-events-none transition";
